...
label_1=Label(window,text="SMALL SIZE",bg="alice blue",height=5,width=10).place(x=0,y=100)
label_2=Label(window,text="MEDIUM SIZE",bg="alice blue",height=5,width=10).place(x=0,y=300)
label_2=Label(window,text="LARGE SIZE",bg="alice blue",height=5,width=10).place(x=0,y=500)
...
button_1=Button(window,image=photo_1,fg="black",bg="PaleTurquoise3",command=Buttonpresstracker,height=200,width=190).place(x=200,y=0)
...
button_2=Button(window,image=photo_2,fg="black",bg="PaleTurquoise3",command=Buttonpresstracker_1,height=200,width=190).place(x=200,y=210)
...
button_3=Button(window,image=photo_4,fg="black",bg="PaleTurquoise3",command=Buttonpresstracker_2,height=200,width=190).place(x=200,y=420)
...
def open_popup():
	...
	def button_bill():
		...
		label_3=Label(top,text=bill,bg="SpringGreen4").place(x=100,y=60)
